      ...
      <div className="bg-white rounded-lg shadow p-8 mb-16">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 mb-4">
            Founded in 2024, KarachiKART has grown from a small local business to one of
            the leading e-commerce platforms in Pakistan. Our journey began with a simple
            mission: to provide quality products at affordable prices while delivering
            exceptional customer service.
          </p>
          <p className="text-gray-600">
            Today, we serve thousands of customers across the country, offering a wide
